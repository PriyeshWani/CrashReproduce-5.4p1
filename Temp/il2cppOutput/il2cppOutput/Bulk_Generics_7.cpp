...
IL_003d:
	{
		...
		__this->set_U3CelapsedTimeU3E__1_1((0.0f));
...
IL_004d:
	{
		...
		float L_4 = (float)__this->get_U3CelapsedTimeU3E__1_1();
...
IL_007a:
	{
		NullCheck(G_B8_2);
		G_B8_2->set_U3CelapsedTimeU3E__1_1(((float)((float)G_B8_1+(float)G_B8_0)));
		// var percentage = Mathf.Clamp01(elapsedTime / tweenInfo.duration);
		float L_9 = (float)__this->get_U3CelapsedTimeU3E__1_1();
...
IL_00d6:
	{
		// while (elapsedTime < tweenInfo.duration)
		float L_16 = (float)__this->get_U3CelapsedTimeU3E__1_1();
